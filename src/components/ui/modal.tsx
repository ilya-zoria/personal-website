...
export function Modal({ 
  ...
  return (
    ...
    >
      <div className={`${width} w-full max-h-[calc(100vh-1.5rem)] sm:max-h-[calc(100vh-3rem)] m-3 sm:mx-6 overflow-auto scrollbar-hide bg-background border-radius-outside cursor-default ${
